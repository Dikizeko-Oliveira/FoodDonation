<?php
  ...
  if(empty($password_hash)) {
    $edit_query = "UPDATE users SET username = '$username', email = '$email' ,cell_phone = '$cell_phone', cep = '$cep', about = '$about', street_number = '$street_number',  district = '$district', city = '$city', state = '$state', complement = '$complement', street = '$street' WHERE id = $user_id";
    mysqli_query($connection, $edit_query);
    $_SESSION['msg'] = "<p style='color: #50FA7B; padding-top: 10px;'>Operação feita com sucesso!</p>";
    header("Location: ong_perfil.php");
  } else {
    $edit_query = "UPDATE users SET username = '$username', email = '$email' ,cell_phone = '$cell_phone', cep = '$cep', about = '$about', street_number = '$street_number',  district = '$district', city = '$city', state = '$state', complement = '$complement', street = '$street', password_hash = $password_hash WHERE id = $user_id";
    mysqli_query($connection, $edit_query);
    $_SESSION['msg'] = "<p style='color: #50FA7B; padding-top: 10px;'>Operação feita com sucesso!</p>";
    header("Location: ong_perfil.php");
  }
